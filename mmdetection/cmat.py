...
def parse_args():
    ...
    parser.add_argument('--val', help='validation set path for confusion matrix')
    parser.add_argument(
        '--score-thr',
        type=float,
        default=0.0,
...
def main1():
    ...
    cfg.data.test.ann_file = os.path.join(root_path, args.val)
...
def main2():
    ...
    plot_confusion_matrix(
        ...
        save_dir='/'.join(args.out.split('/')[:-1]),
        show=args.show,
